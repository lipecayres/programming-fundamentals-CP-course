...
public class MovieTicketTestHarness {                                                    //Create a second class called AirlineReservation 
    public static void main (String [] args) {                                                  // Main method
        ...
        MovieTicket ar1 = new MovieTicket("Jack", "Blue", 1020, 3 , 334547);
        ...
        MovieTicket ar2 = new MovieTicket();   
